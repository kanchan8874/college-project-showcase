            ...
            <div className="mx-auto max-w-screen-lg px-4 md:px-6">
                <header className="flex justify-between py-3 md:py-4 items-center">
                    ...
                    <button
                        ...
                        className="lg:hidden inline-flex items-center gap-2 rounded-lg bg-gray-200 px-2.5 py-2 text-sm font-semibold text-gray-500 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base"
                    >
                ...
                {/* Mobile Menu */}
                {isMenuOpen && (
                    <div className="lg:hidden flex flex-col bg-blue-950 text-white p-4 rounded-lg mt-2">
