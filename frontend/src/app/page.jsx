...
const Home = () => {
    return (
        <>
            ...
            {/* hero Section */}
            <div className="pt-0">
                <section className="relative py-10 bg-gradient-to-r from-gray-100 to-white sm:h-[100vh] lg:h-[100vh] h-full overflow-hidden">
                    {/* Background with parallax effect */}
                    <div 
                        className="absolute inset-0 bg-cover bg-center opacity-10 animate-float"
                        style={{ backgroundImage: "url('https://plus.unsplash.com/premium_photo-1701509665932-e38d5eaad17d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDJ8fHxlbnwwfHx8fHw%3D')" }}
                    ></div>
                    ...
                    <div className="relative px-12 mx-auto max-w-7xl">
                        <div className="w-full mx-auto md:w-11/12 xl:w-9/12 md:text-center">
                            ...
                            <div className="mb-4 space-x-0 md:space-x-7 md:mb-2 font-semibold">
                                <Link 
                                    href="/browseproject" 
                                    className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-blue-900 rounded-2xl sm:w-auto sm:mb-0 hover:scale-105 transition-transform duration-300 "
                                >
                                    Get Started
                                </Link>
                                <Link 
                                    href="/learnmore" 
                                    className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-semibold bg-green-400 rounded-2xl sm:w-auto sm:mb-0 hover:scale-105 transition-transform duration-300 "
                                >
                                    Read More
                                </Link>
                            </div>
