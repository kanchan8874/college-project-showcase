            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div className="lg:w-10/12 w-full">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 dark:text-white mt-6">
                        This web application is designed to showcase college projects in an organized and interactive way. It helps students display their work to peers, faculty, and potential recruiters. The platform aims to bridge the gap between talent and opportunity by giving students a platform to highlight their skills and innovations.
                    </p>
                </div>
